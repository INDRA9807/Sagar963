...
logo = """🔥                          \033[1;36m𓆰𓃮𓆪                         🔥              
 ...
 |_____/_____/|_|  \_\ |_|  \_\\____/|______|______/_/ \_\
                                                                                                                    
                                                            \033[1;96m 𝐓
 \x1b[1;97m===========================================================
 \033[1;37m[*] FOUNDER     : \033[1;36mINDRA X RAJ
 \033[1;37m[*] MAKER       : \033[1;36mABHI THAKUR
 \033[1;37m[*] STATUS      : \033[1;91mFREE
 \033[1;37m[*] RULEX       : SOLAR SQUAD RULEX
...
def verInput(data):
    ...
    return dataInput
marshalHead = '#ENCODED BY : SSR-RULEX\n#ENCRYPTION : Py3 MARSHAL\n#GITHUB : https://github.com/INDRA9807\n#----------------------------------------------\nimport marshal\nexec(marshal.loads('
marshalTail = '))'
b64Head = '#ENCODED BY : SSR-RULEX\n#ENCRYPTION : Py3 BASE64\n#GITHUB : https://github.com/INDRA9807\n#----------------------------------------------\nimport base64\nexec(base64.b64decode('
b64Tail = '))'
zlibHead = '#ENCODED BY : SSR-RULEX\n#ENCRYPTION : Py3 ZLIB\n#GITHUB : https://github.com/INDRA9807\n#----------------------------------------------\nimport zlib\nexec(zlib.decompress('
zlibTail = '))'
mbHead = '#ENCODED BY : SSR-RULEX\n#ENCRYPTION : Py3 MARSHAL+BASE64\n#GITHUB : https://github.com/INDRA9807\n#----------------------------------------------\nimport marshal, base64\nexec(marshal.loads(base64.b64decode('
mbTail = ')))'
allHead = '#ENCODED BY : SSR-RULEX\n#ENCRYPTION : Py3 MARSHAL+ZLIB+B64\n#GITHUB : https://github.com/INDRA9807\n#----------------------------------------------\nimport marshal, base64, zlib\nexec(marshal.loads(zlib.decompress(base64.b64decode('
allTail = '))))'

def encodeMarshal(data):
    code = compile(data, '___SSR-RULEX___', 'exec')
...
def encodeMb(data):
    data = compile(data, '___SSR-RULEX___', 'exec')
